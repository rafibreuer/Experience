...
class NewWorkShop extends React.Component<any, any> {
    ...
    componentWillMount(){
            this.props.ModuleIsSubmited(false);
        }
    ...
    render() {
        let button;
        if (!this.props.moduleIsSubmited) button = <Button buttonName="Add" className="btn btn-success" />;
        return (
            <div>
                <button type="button" className="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Add A Work Shop</button>
                        ...
                        <div className="modal-content">
                            ...
                            <div id="myModal" className="modal-body">
                                <Form submit={this.submit}>
                                    ...
                                    <Input value={this.state.form.url} placeholder='you tube url' name='url' required={true} type='text' onChange={this.onChange} errorMessage="Url Is Required" />
